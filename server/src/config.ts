...
export const config = {
  ...
  razorpayPaymentLinkUrl: optional("RAZORPAY_PAYMENT_LINK_URL"),
  razorpayWebhookSecret: optional("RAZORPAY_WEBHOOK_SECRET"),
  razorpayAmountPaise: Number(optional("RAZORPAY_AMOUNT_PAISE", "5000")),
  razorpayCurrency: optional("RAZORPAY_CURRENCY", "INR"),
  licenseUnlockCodes: csv("LICENSE_UNLOCK_CODES"),
